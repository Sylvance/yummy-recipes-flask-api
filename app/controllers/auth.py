...
@auth.route('/authentication/reset/password', methods=['POST'])
@token_required
...
auth.add_url_rule('/authentication/register', view_func=registration_view, methods=['POST'])
auth.add_url_rule('/authentication/login', view_func=login_view, methods=['POST'])
auth.add_url_rule('/authentication/logout', view_func=logout_view, methods=['POST'])
